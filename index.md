...
<br>
<br/><center><h3 id="aboutMe"><strong>About Me</strong></h3></center>
...
&nbsp;&nbsp;&nbsp;&nbsp;I chose to create this program to show that I can start from scratch and create something functional that I can use every day. I believe that this artifact will show that I have a pretty good skill set in coding practices. It will show that I know a wide array or good coding practices like properly naming and assigning variables, commenting, using proper control flow, and secure coding. I still have more functionality to add to this program and comments to add but it is starting to take shape.<br> 
